...
convert -size 192x192 xc:#259783 -pointsize 80 -fill white -gravity center -annotate +0+0 "🛒" public/icon-192.png 2>/dev/null || \
...
convert -size 512x512 xc:#259783 -pointsize 200 -fill white -gravity center -annotate +0+0 "🛒" public/icon-512.png 2>/dev/null || \
