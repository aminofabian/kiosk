        ...
        <div className="sticky top-0 z-10 bg-white/80 dark:bg-[#0f1a0d]/80 backdrop-blur-lg border-b border-slate-200 dark:border-slate-800">
          <div className="px-4 md:px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white">Profit Report</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400">Detailed profit analysis</p>
              </div>
            </div>
          </div>
        </div>
